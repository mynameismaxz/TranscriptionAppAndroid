    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Login loginn = new Login("http://203.151.94.63/transcription/chkloginandroid.php");
                String result = null;
                String user = null;
                String status = null;
                try {
                ...
                if(Objects.equals(result, "error")){
                    Snackbar.make(rootLayout,"An error occurred",Snackbar.LENGTH_SHORT).show();
                }
                JSONObject Object;
                try {
                ...
                if(Objects.equals(status, "ss")){
                    ...
                    Snackbar.make(rootLayout,"Wrong Username or password :)",Snackbar.LENGTH_LONG).show();
                }
            }
        });
